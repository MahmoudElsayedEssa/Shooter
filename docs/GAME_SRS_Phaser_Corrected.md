...
#### Proof
- static/diff check for forbidden runtime dependencies
- architecture-contract check after SRS import
- roadmap/trace check must include REQ, ARCH, and METHOD items
